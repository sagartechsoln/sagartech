...
const Product = () => {
  ...
  const [makeitfeaturedChecked, setmakeitfeaturedChecked] = useState();
  ...
  function handleUpdate(key) {
    ...
    setmakeitfeaturedChecked(selectedRow.makeitfeatured)
  }

  console.log(ctaChecked);
            ...
            <>
              ...
              >
                <Form form={form} className="mt-2">
                  ...
                  <Form.Item name="makeitfeatured" label="is it Featured Product?" rules={[{ required: true, message: 'Please select any one makeitfeatured' }]}>
                    <div className='flex gap-5'>
                      <div className="flex items-center">
                        <input type="radio" id="makeitfeatured1" name="makeitfeatured" value={1} className="appearance-none h-4 w-4 border border-gray-300 rounded-full checked:bg-blue-600 checked:border-transparent"
                          checked={makeitfeaturedChecked === "1" && makeitfeaturedChecked != undefined ? "checked" : undefined}
                        />
                        <label htmlFor="makeitfeatured1" className="ml-2">Yes</label>
                      </div>
                      <div className="flex items-center">
                        <input type="radio" id="makeitfeatured2" name="makeitfeatured" value={0} className="appearance-none h-4 w-4 border border-gray-300 rounded-full checked:bg-blue-600 checked:border-transparent"
                          checked={makeitfeaturedChecked === "0" && makeitfeaturedChecked != undefined ? "checked" : undefined}
                        />
                        <label htmlFor="makeitfeatured2" className="ml-2">No</label>
                      </div>
                    </div>
                    {/* Add more radio buttons as needed */}
                  </Form.Item>
              ...
              <Modal
                ...
                okText="Upload"
              >
                <p>Note: After Uploading each images click on upload</p>
