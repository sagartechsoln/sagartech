    ...
    return (
        <>
            <div className="bg-slate-800 flex min-h-full h-screen flex-1 flex-col justify-center items-center">
                {
                    pageLoad ? <div
                    class="inline-block h-24 w-24 animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] text-secondary motion-reduce:animate-[spin_1.5s_linear_infinite]"
                    role="status">
                    <span
